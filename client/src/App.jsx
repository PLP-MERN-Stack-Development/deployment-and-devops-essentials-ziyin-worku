...
export default function App() {
  const { user } = useUser();
  const displayName =
    user?.fullName || user?.username || user?.firstName || "Guest";
      ...
      <header className="border-b border-white/10 bg-white/[0.03]">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-5">
          <div className="space-y-1">
            ...
            <h1 className="text-2xl font-semibold text-white">MERN Chat</h1>
        ...
        <SignedOut>
          <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-4 text-center text-slate-200">
            ...
            <p className="mt-3 text-base text-slate-400">
              Sign in to start chatting with your team in real-time. Secure
